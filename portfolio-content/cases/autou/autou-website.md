...
**Stack:** Vite + React + TypeScript, FastAPI + Pydantic, PostgreSQL (instância Aura), CMS próprio para artigos/cases, SSG/ISR para SEO, Docker Compose, Microsoft Azure, Nginx
