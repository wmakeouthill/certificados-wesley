...
Desenvolvedor brasileiro apaixonado por criar soluções inovadoras e superar desafios técnicos. Atualmente atuando como Estagiário Desenvolvedor Fullstack na ANBIMA/Selic em convênio com o Banco Central, trabalhando na modernização de infraestrutura financeira crítica, especificamente na migração do sistema Selic de mainframe (COBOL) para arquitetura Java moderna.

Perfil curioso, focado em aprendizado contínuo e sempre com um projeto novo em mente. Especializado em desenvolvimento full-stack com foco em arquiteturas modernas, Clean Architecture e tecnologias enterprise. Experiência diversificada em diferentes setores: jurídico, tabaco, energia e infraestrutura financeira crítica.
...
- **Python:** Automações, scripts e web scraping
...
- **Python** - Scripts de automação, análise de dados e web scraping
- **VBA** - Automações em Excel e sistemas Microsoft
- **SharePoint** - Desenvolvimento web corporativo
...
**2025-Atual:** Desenvolvimento Full-Stack em sistemas críticos (ANBIMA/Selic)
